...
<!-- counts: bundles=29, tier1=25, tier1remaining=2, statebuilt=29, statecandidate=174, stateoutofscope=2, commoncandidates=57, adrs=50, cisteps=31, checkk=100, checkformats=86, checklogs=91, logsgated=23, sourcesgated=974 -->
...
`<!-- counts: bundles=29, tier1=24, adrs=35 -->`. The check recomputes each from the tree and fails on
