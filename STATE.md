...
<!-- counts: bundles=28, tier1=25, tier1remaining=2, statebuilt=28, statecandidate=175, stateoutofscope=2, commoncandidates=58, adrs=48, cisteps=31, checkk=98, checkformats=84, checklogs=90, logsgated=22, sourcesgated=894 -->
...
`<!-- counts: bundles=28, tier1=24, adrs=35 -->`. The check recomputes each from the tree and fails on
