...
| [0029](0029-gate-the-research-log-contract-not-its-layout.md) | Gate the research log's contract (per-source retrieval record), not its layout; two numbered layouts stay legal, three status-less logs are converted (closes DF-2) | 2026-07-27 |
