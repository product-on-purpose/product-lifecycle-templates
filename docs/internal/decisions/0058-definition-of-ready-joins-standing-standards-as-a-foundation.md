...
- **Status:** accepted 2026-09-23. The maintainer directed the build that day; the agent drafted the
  classification argument against the contract and ADR 0032, and it is reviewable in the change that
  carries it.
...
[ADR 0041](0041-maintainer-preference-sets-the-build-order.md) (GitHub issue #178).
