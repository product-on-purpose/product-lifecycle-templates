...
* Option B: execute P3 (the CI gate port) as planned (Node script suite plus ci.yml) before or alongside content.
...
Provenance: accepted as interim (decided 2026-07-03; transcribed 2026-07-11; ratified 2026-07-12; supersession condition below)
