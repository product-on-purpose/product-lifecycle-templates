...
* Housekeeping: the plan's P1 (the four foundational decisions) step 4 text and any doc still teaching `deliver-prd`-style template IDs should gain a superseded note pointing here.

## More Information

Provenance: accepted (practice settled 2026-06-30 in methodology v0.2.0; transcribed 2026-07-11; ratified 2026-07-12)
