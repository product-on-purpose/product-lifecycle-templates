...
- **Status:** plan of record **for S1 and beyond**. Adopted by [ADR 0046 (the site is Astro plus Starlight under Pattern S)](decisions/0046-the-site-is-astro-starlight-under-pattern-s.md). **S0 shipped 2026-09-21 in `v0.9.0` and the site is live** at <https://product-on-purpose.github.io/product-lifecycle-templates/>, serving every bundle in the library (30 at launch). *(Corrected 2026-09-22: this line read "Nothing is built" for a day after the site went live, which is the forward-looking-prose failure the release process names as its own step 7.)*
