...
>
> **Freshness note added 2026-07-26, itself corrected 2026-07-28 (finding DF-5, prose counts drift):** that list of three divergences is itself dated. This file last cites **ADR 0020**; there are now **54** decision records (re-corrected 2026-08-22 and again 2026-09-20; the 28 this sentence originally carried was stale within days and the 41 that replaced it lasted a month, which is DF-3 recurring twice inside the note written to manage it), and the thirty-four since (0021 through 0054) have changed the taxonomy, the family model, the gate, and the variant model. For what is actually being built and in what order, read [`buildout-specs.md`](buildout-specs.md), not this file. Recorded as finding **DF-3** in STATE.md.
>
