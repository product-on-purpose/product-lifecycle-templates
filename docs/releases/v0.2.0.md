...
description: "The Tier-1 floor completed at 26 bundles, plus the library's first user-facing documentation"
audience: both
level: beginner
...
**A front door.** [`docs/getting-started.md`](../tutorials/getting-started.md),
[`docs/choosing-a-template.md`](../reference/choosing-a-template.md),
[`docs/filling-a-template.md`](../how-to/filling-a-template.md),
[`docs/what-the-gate-proves.md`](../explanation/what-the-gate-proves.md), plus `CONTRIBUTING.md` and `AGENTS.md` at the
...
**An installable surface.** [`SKILL.md`](../../skills/plt-fill-template/SKILL.md) and `.claude-plugin/plugin.json`.
...
<!-- counts: cisteps=20, logsgated=24, sourcesgated=1046 -->
...
[`SKILL.md`](../../skills/plt-fill-template/SKILL.md).
