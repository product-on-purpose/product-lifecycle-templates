...
|---|---|---|
| **Claude Code plugin** | both skills **and** all 31 bundles | you want the library to work. **This is the recommended route** |
...
Ask your agent to list the available document types. It should read `manifest.json` and name 31 bundles.
...
fetch any of the 65 template variants, fetch a grading pack, validate a filled document, and strip and
...
Everything is present: 31 bundles, the research logs behind every claim, the gate, the evals. Nothing
