...
The question was deferred on purpose and for a good reason: because lifecycle phase is carried in metadata and never in the path ([20260630-bundle-ids-doctype-spine.md](20260630-bundle-ids-doctype-spine.md)), the directory layout is a derivable, late-binding choice rather than a load-bearing one. Nothing depended on answering it early.
