...
- **The `definition-of-ready` spec, and [ADR 0058](docs/internal/decisions/0058-definition-of-ready-joins-standing-standards-as-a-foundation.md)
  proposing it for `standing-standards` as a `foundation`** (contract `0.3.0`, proposed). Admitted at the
  ...
  trigger fires both ways. **Proposed, not accepted**, until the maintainer confirms the build.
