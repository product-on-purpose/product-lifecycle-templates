...
| | |
|---|---|
| **Weighted total** | **1,713,266** token-equivalents |
| **At API list rates** | **$5.14** |
| Subagents | 9 across 2 workflow run(s) |
| API responses | 91 |
| Fresh input | 19,058 |
| Cache write | 518,004 |
| Cache read | 3,156,878 |
| Output | 146,203 |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| `other` | 5 | 14,153 | 357,098 | 1,705,884 | 91,107 | **1,086,649** | $3.26 |
| `research` | 4 | 4,905 | 160,906 | 1,450,994 | 55,096 | **626,617** | $1.88 |

### By model

| resolved model | agents | input | cache write | cache read | output | weighted | list USD |
|---|---:|---:|---:|---:|---:|---:|---:|
| `claude-sonnet-4-6` | 9 | 19,058 | 518,004 | 3,156,878 | 146,203 | **1,713,266** | $5.14 |

### By requested tier

| requested | agents | input | cache write | cache read | output | weighted | list USD |
|---|---:|---:|---:|---:|---:|---:|---:|
| `sonnet` | 9 | 19,058 | 518,004 | 3,156,878 | 146,203 | **1,713,266** | $5.14 |

### By deliverable

| deliverable | agents | input | cache write | cache read | output | weighted | list USD |
|---|---:|---:|---:|---:|---:|---:|---:|
| `(none)` | 9 | 19,058 | 518,004 | 3,156,878 | 146,203 | **1,713,266** | $5.14 |
