...
<a id="ref-7"></a>[7] "[Master Catalog of Product Management and SDLC Document and Artifact Types](../../initial-discovery/docs/deep-research_master-catalog.md)," entry 115 (Release Notes). Internal deep-research catalog, 2026. [internal]
