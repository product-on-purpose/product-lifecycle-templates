...
2. Move into place:
   - `decisions/*.md` to `docs/decisions/`
...
| decisions/20260629-repo-and-package-name.md | `product-lifecycle-templates` everywhere; `pm-` prefix dropped | Strategy brief section 5 item 1; plan P1 step 2 |
| decisions/20260629-variant-model.md | lean/full descriptive filenames + strict nesting | Strategy brief section 5 item 2; plan P1 step 3 |
| decisions/20260629-phase-vocabulary.md | Lowercase phase values matching pm-skills | Strategy brief section 5 item 3; plan P1 step 4 |
| decisions/20260629-first-family-and-bundle.md | delivery-docs first; prd first | Strategy brief section 5 item 4; plan P1 step 5 |
| decisions/20260630-bundle-ids-doctype-spine.md | **Bundle IDs are bare doc-type handles; phase lives in metadata, never in path or ID.** Not in the audit's list of seven; surfaced during transcription because the plan's intended ADR said IDs would be `deliver-prd` style and practice deliberately diverged (methodology section 2). This records the divergence as the decision it was | methodology.md:41; contrast with plan P1 step 4 |
| decisions/20260630-guidance-style-approach-a.md | Enriched HTML comments (Approach A) | _working/README.md; methodology B1 |
| decisions/20260630-research-log-as-8th-file.md | Research log is a committed bundle artifact | Methodology DoD; gate ROLES; G6 idea HY-3 |
| decisions/20260703-gate-python-local-interim.md | Python local gate as decided interim; supersession condition stated | check-bundles.py docstring; README line 106 |
