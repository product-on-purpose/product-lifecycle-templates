...
The rubrics come from the same 32 bundles, covering all 25 templatable Tier-1 document types plus seven Tier-2 types.
...
- **The document is not one of the 32 types.** Say so and offer a structure-only review. Grading a
